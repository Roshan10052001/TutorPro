					...
					<section className='hero-section'>
						<div className='hero-content'>
							...
							<p>
								...
								time slots, and manage sessions in one clean platform. Tutors
								can apply, share their availability, and support students with a
								more organized flow. Admins can review applications and keep the

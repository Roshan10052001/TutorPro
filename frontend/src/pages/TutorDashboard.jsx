...
function TutorDashboard() {
	...
	const sessions = [];
	const { mutate: updateTutorAvailability } = () => {};
	...
	const handleAvailabilitySave = () => {
		...
		if (newSlots !== null) {
			updateTutorAvailability({ email: user?.email, slotsText: newSlots });
			...
			<main className='dashboard-main'>
				...
				<section className='dashboard-panel enhanced-panel'>
					...
					{myTutorProfile ? (
						<>
							<p>
								<strong>Course:</strong> {myTutorProfile.course}
							</p>
							<p>
								<strong>Bio:</strong> {myTutorProfile.bio}
							</p>

...
=======
>>>>>>> a034e61ac4fafe1c35b2635f307d36982aabfb03
            ...
            <div className="profile-grid">
              <div className="profile-field">
                ...
                {isEditing ? (
                  ...
                  <div className="profile-value">{formData.major || 'Not provided'}</div>
                )}
              </div>
              ...
              <div className="profile-field">
                ...
                {isEditing ? (
                  ...
                  <div className="profile-value">{formData.year || 'Not provided'}</div>
                )}
              </div>
            </div>
          </section>
            ...
            <div className="profile-grid">
              <div className="profile-field">
                ...
                {isEditing ? (
                  ...
                  <div className="profile-value">{formData.subjects || 'Not provided'}</div>
                )}
              </div>
